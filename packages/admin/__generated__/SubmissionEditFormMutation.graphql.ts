/**
 * @generated SignedSource<<ba0978c1dffaee5e0fe2786ee364e571>>
...
export type SubmissionEditFormMutation$variables = {
  input: CreateItemInput;
};
export type SubmissionEditFormMutation$data = {
  readonly createItem: {
    readonly item: {
...
export type SubmissionEditFormMutation = {
  response: SubmissionEditFormMutation$data;
  variables: SubmissionEditFormMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "SubmissionEditFormMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "7f1a419931c8d76a472282a6127e1b11",
    "id": null,
    "metadata": {},
    "name": "SubmissionEditFormMutation",
    "operationKind": "mutation",
    "text": "mutation SubmissionEditFormMutation(\n  $input: CreateItemInput!\n) {\n  createItem(input: $input) {\n    item {\n      title\n      slug\n      id\n    }\n    ...MutationForm_mutationErrors\n  }\n}\n\nfragment MutationForm_mutationErrors on StandardMutationPayload {\n  __isStandardMutationPayload: __typename\n  attributeErrors {\n    path\n    type\n    messages\n  }\n  globalErrors {\n    message\n  }\n}\n"
  }
};
})();

(node as any).hash = "5570e12fd7028298d57e592f7cbab182";
